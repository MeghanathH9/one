...
<head>
    ...
    <title>MetaShop - Modern E-Commerce</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            <a href="#" class="logo">Meta<span>Shop</span></a>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Winter Collection 2023 Version 1</h1>
    ...
    <footer>
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2023 MetaShop. All rights reserved.</p>
            </div>
        </div>
    </footer>
